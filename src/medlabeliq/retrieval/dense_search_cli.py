...
from medlabeliq.retrieval.dense_search import dense_search_chunks


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Search section-aware DailyMed chunks using dense Qdrant retrieval."
    )
    ...
    parser.add_argument(
        "--family",
        default=None,
        help="Optional retrieval_family filter",
    )
